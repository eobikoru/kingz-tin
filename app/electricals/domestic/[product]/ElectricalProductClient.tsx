...
import DomesticSimilarProduct from "@/src/component/similar-products/electrical/domestic"

const formatPrice = (price: string) => {
  return price.replace(/\B(?=(\d{3})+(?!\d))/g, ",")
}

const ElectricalProductClient = ({ item }: { item: any }) => {
...
export default ElectricalProductClient
