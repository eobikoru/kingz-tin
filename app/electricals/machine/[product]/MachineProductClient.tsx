...
import MachineSimilarProduct from "@/src/component/similar-products/electrical/machine"

const formatPrice = (price: string) => {
  return price.replace(/\B(?=(\d{3})+(?!\d))/g, ",")
}

const MachineProductClient = ({ item }: { item: any }) => {
...
export default MachineProductClient
