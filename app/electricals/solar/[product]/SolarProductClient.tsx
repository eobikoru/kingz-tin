...
import SolarSimilarProduct from "@/src/component/similar-products/electrical/solar"

const formatPrice = (price: string) => {
  return price.replace(/\B(?=(\d{3})+(?!\d))/g, ",")
}

const SolarProductClient = ({ item }: { item: any }) => {
...
export default SolarProductClient
