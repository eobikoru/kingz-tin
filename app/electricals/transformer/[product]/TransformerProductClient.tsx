...
import TransformerSimilarProduct from "@/src/component/similar-products/electrical/transformer"

const formatPrice = (price: string) => {
  return price.replace(/\B(?=(\d{3})+(?!\d))/g, ",")
}

const TransformerProductClient = ({ item }: { item: any }) => {
...
export default TransformerProductClient
