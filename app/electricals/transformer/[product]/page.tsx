...
import TransfomerSimilarProduct from "@/src/component/similar-products/electrical/transformer";

const formatPrice = (price: string) => {
  return price.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
};

const TransformerProduct = ({ params }: { params: { product: string } }) => {
