...
import FireAlarmSimilarProduct from "@/src/component/similar-products/electronics/fire-alarm"

const formatPrice = (price: string) => {
  return price.replace(/\B(?=(\d{3})+(?!\d))/g, ",")
}

const FireAlarmProductClient = ({ item }: { item: any }) => {
...
export default FireAlarmProductClient
